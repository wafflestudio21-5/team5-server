...
class PostServiceTest @Autowired constructor(
    ...
    @BeforeEach
    fun setup() {
        testUser1 = createUser("testuser1", "Test User")
        testUser2 = createUser("testuser2", "Test User2")
    }

    private fun createUser(username: String, name : String): UserEntity {
        val user = UserEntity(
            username = username,
            name = name,
    ...
    private fun createPost(content: String, user: UserEntity): PostEntity {
        val post = PostEntity(
            content = content,
